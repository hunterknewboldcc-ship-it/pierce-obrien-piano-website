# Pierce O’Brien Piano — Owner Decisions Required Before Launch

## Purpose and source boundary

This is the launch decision log for the new website. It is grounded in:

- `piano-tuner-seo-package/00-questionnaire-grounding.md`
- `piano-tuner-seo-package/01-brand-identity-brief.md`
- `piano-tuner-seo-package/02-content-strategy.md`
...
- [ ] **Photography releases:** Confirm ownership and permission for every supplied image, including owner portrait/work images, recognizable people, homes, venues, and instruments. Use authentic Pierce photography first; use only non-deceptive stock as a supplement if approved; do not use AI-generated imagery.

## Launch blockers — copy, brand, and conversion

- [ ] **Finished website copy:** Approve the copywriter’s completed page copy or retain `[COPY PENDING]` sections. Do not fill gaps with claims taken from legacy Wix pages, competitor sites, social captions, or unapproved reviews.
...
## Launch blockers — Google, domain, and operational access

- [ ] **Google Business Profile:** Confirm whether a profile exists, who owns it, whether it is claimed and verified, service-area versus storefront settings, category selection, hours, public phone, booking link, and approved service descriptions.
- [ ] **Local consistency:** Confirm that the approved business name, public phone, email, hours, website URL, booking link, and service area match Google Business Profile and other listings before launch.
- [ ] **Domain and DNS control:** Confirm control of `pierceobrienpiano.com` and `www.pierceobrienpiano.com`, registrar / DNS access, existing Wix configuration, SSL ownership, and who will execute the cutover.
- [ ] **Canonical host:** Approve `https://www.pierceobrienpiano.com` as the canonical public host, or explicitly choose another host before deployment. All alternatives should resolve in one hop to the final host.
- [ ] **Legacy content migration:** Approve the retirement of unoffered lessons, portal, and course content; approve the mapping in `docs/legacy-redirect-map.md`; and identify any legacy news article that merits a content-specific replacement rather than retirement.
- [ ] **Legal / privacy essentials:** Supply the business mailing/contact information appropriate for the privacy policy, form data-retention rules, third-party services (including Gazelle and analytics), and any required terms or disclosures.
- [ ] **Launch ownership:** Name the person responsible for booking checks, lead response, content updates, review requests, analytics monitoring, and post-launch 404/redirect review.

## Required pre-launch evidence pack

Collect these before switching the live domain:
...
8. Final copy approval, privacy / form handling decisions, and the named launch owner.

## Final launch gate

Do not launch public claims, structured data, contact CTAs, pricing, promotions, or booking integrations until the corresponding checkbox is complete. A polished website that defers an unknown detail is preferable to one that publishes an unsupported promise or sends a prospective client to a broken path.
